...
{
    /// <summary>
    /// 更新特巡报告头部及明细 接口编号=1003
    /// </summary>
    [DataContract]
    public class ResUpdatePatrol
    {
        ...
        public ResUpdatePatrol()
        {
            this.function_id = ((int)MessageHelper.WebFunctionIDs.UpdatePatrol).ToString();//注意枚举ToString直接得到字符串
            this.SetFailed();
        }
