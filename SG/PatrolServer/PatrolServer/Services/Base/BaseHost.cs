...
namespace PatrolServer.Services.Base
{
    ...
    public class BaseHost
    {
        ...
        private static bool InitByConfig()
        {
            ...
            try
            {
                ServiceHost serviceHost = new ServiceHost(typeof(BaseService));
        ...
        private static bool InitByUser()
        {
            ...
            try
            {
                Uri baseAddress = new Uri("http://localhost:8732/PatrolService/Base/");
                ServiceHost serviceHost = new ServiceHost(typeof(BaseService));
                WebHttpBinding binding = new WebHttpBinding();
                binding.MaxBufferSize = int.MaxValue;
                binding.MaxReceivedMessageSize = int.MaxValue;
                binding.TransferMode = TransferMode.Buffered;
                ServiceEndpoint endpoint = serviceHost.AddServiceEndpoint(typeof(IBaseService), binding, baseAddress);
        ...
        {
            Console.WriteLine("BaseService Start Success!");
        }
    }
}
