...
namespace Model.BusinessRule
{
    ...
    /// 建友分公司业务类
    /// </summary>
    public class SUBCOMPANYMSTRule
    {
        #region 内部属性

        private static SUBCOMPANYMSTHelper controller = new SUBCOMPANYMSTHelper();
        ...
        public static bool Insert(SUBCOMPANYMST entity)
        {
            if (entity != null)
            {
        ...
        /// <returns>true=成功,false=失败</returns>
        public static bool Update(SUBCOMPANYMST entity,Hashtable updateKeys)
        {
        ...
        /// <returns></returns>
        public static bool Delete(SUBCOMPANYMST entity)
        {
            if (entity != null)
            {
        ...
        /// </summary>
        /// <returns></returns>
        public static List<SUBCOMPANYMST> SelectAll()
        {
        ...
        public static SUBCOMPANYMST Select(SUBCOMPANYMST searchInfo)
        {
            if (searchInfo == null)
            {
                return null;
        ...
        public static List<SUBCOMPANYMST> SearchByCondition(SearchInfo searchInfo) {
            if (searchInfo == null)
            {
                return null;
            }
        ...
        /// </summary>
        /// <returns></returns>
        public static List<SUBCOMPANYMST> GetList()
        {
            return controller.SelectAll();
        }
