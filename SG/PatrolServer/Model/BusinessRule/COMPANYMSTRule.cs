...
namespace Model.BusinessRule
{
    ...
    /// 建友代理店业务类
    /// </summary>
    public class COMPANYMSTRule
    {
        #region 内部属性

        private static COMPANYMSTHelper controller = new COMPANYMSTHelper();
        ...
        public static bool Insert(COMPANYMST entity)
        {
            if (entity != null)
            {
        ...
        /// <returns>true=成功,false=失败</returns>
        public static bool Update(COMPANYMST entity,Hashtable updateKeys)
        {
        ...
        /// <returns></returns>
        public static bool Delete(COMPANYMST entity)
        {
            if (entity != null)
            {
        ...
        /// </summary>
        /// <returns></returns>
        public static List<COMPANYMST> SelectAll()
        {
        ...
        public static COMPANYMST Select(COMPANYMST searchInfo)
        {
            if (searchInfo == null)
            {
                return null;
        ...
        public static List<COMPANYMST> SearchByCondition(SearchInfo searchInfo) {
            if (searchInfo == null)
            {
                return null;
            }
        ...
        /// </summary>
        /// <returns></returns>
        public static List<COMPANYMST> GetList()
        {
            return controller.SelectAll();
        }
