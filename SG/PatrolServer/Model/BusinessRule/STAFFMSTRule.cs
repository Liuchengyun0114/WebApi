...
namespace Model.BusinessRule
{
    ...
    /// 建友员工业务类
    /// </summary>
    public class STAFFMSTRule
    {
        #region 内部属性

        private static STAFFMSTHelper controller = new STAFFMSTHelper();
        ...
        public static bool Insert(STAFFMST entity)
        {
            if (entity != null)
            {
        ...
        /// <returns>true=成功,false=失败</returns>
        public static bool Update(STAFFMST entity,Hashtable updateKeys)
        {
        ...
        /// <returns></returns>
        public static bool Delete(STAFFMST entity)
        {
            if (entity != null)
            {
        ...
        /// </summary>
        /// <returns></returns>
        public static List<STAFFMST> SelectAll()
        {
        ...
        public static STAFFMST Select(STAFFMST searchInfo)
        {
            if (searchInfo == null)
            {
                return null;
        ...
        public static List<STAFFMST> SearchByCondition(SearchInfo searchInfo) {
            if (searchInfo == null)
            {
                return null;
            }
        ...
        /// </summary>
        /// <returns></returns>
        public static List<STAFFMST> GetList()
        {
            return controller.SelectAll();
        }
